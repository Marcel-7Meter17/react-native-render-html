...
export function generateDefaultTextStyles (baseFontSize = BASE_FONT_SIZE) {
    return {
        ...
        h1: _generateHeadingStyle(baseFontSize, 1.5, 0.83),
        h2: _generateHeadingStyle(baseFontSize, 1.17, 1),
        h3: _generateHeadingStyle(baseFontSize, 1, 1.33),
        h4: _generateHeadingStyle(baseFontSize, 0.83, 1.67),
        h5: _generateHeadingStyle(baseFontSize, 0.67, 2.33),
...
function _generateHeadingStyle (baseFontSize, fontMultiplier, marginMultiplier) {
    return {
        ...
        lineHeight: baseFontSize * fontMultiplier * 1.2,
